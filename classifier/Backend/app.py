...
# CORS
# ==========================================
# Allow all origins so both the deployed Render frontend and local dev
# can call this API. Note: allow_credentials must be False when using
# allow_origins=["*"] (browser security requirement).
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
# ==========================================
# Enhanced Prediction (ML + Intent Rules)
# ==========================================
